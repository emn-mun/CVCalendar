...
public final class CVCalendarView: UIView {
    ...
    public var delegate: CVCalendarViewDelegate? {
        didSet {
            ...
            if rangeSelection == nil {
                rangeSelection = RangeSelection(calendarView: self)
            }
        }
    }
    ...
    // ------- MY STUFF ------
    @IBOutlet public weak var rangeSelectionDelegate: AnyObject? {
        set {
            if let rangeSelectionDelegate = newValue as? RangeSelectionDelegate {
                rangeSelection.delegate = rangeSelectionDelegate
            }
        }
        get {
